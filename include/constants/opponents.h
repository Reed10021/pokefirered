...
#define TRAINER_KIRBY						743
#define TRAINER_REED_YELLOW					744
#define TRAINER_CHRIS_CRYSTAL				745
#define TRAINER_KRIS						746

// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is 
//       only space for (25-4 = 21) additional trainers before trainer flag space overflows.
