...
static const u8 sText_PlayerPanicked[] = _("You panicked and lost ¥{B_BUFF1}…\p… … … …\pYou whited out!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("{B_PLAYER_NAME} is out of\nusable POKéMON!\pYou lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("You paid ¥{B_BUFF1} as the prize\nmoney…\p… … … …\pYou whited out!{PAUSE_UNTIL_PRESS}");
...
const u16 gBallEscapeStringIds[] =
{
    ...
    [BALL_1_SHAKE_FAIL]  = STRINGID_ITAPPEAREDCAUGHT
};
