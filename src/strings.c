...
const u8 gText_CryForm[] = _("{START_BUTTON}CRY {A_BUTTON}FORM {DPAD_UPDOWN}POKéMON");
const u8 gText_NextDataCancel[] = _("{DPAD_RIGHT}NEXT DATA {B_BUTTON}CANCEL");
const u8 gText_Next[] = _("{A_BUTTON}NEXT");
const u8 gText_CancelPreviousData[] = _("{DPAD_LEFT}PREVIOUS DATA {B_BUTTON}CANCEL");
...
const u8 gSaveStatName_ClockTime[] = _("CLOCK TIME");
...
const u8 gText_10000YenAndPrice[] = _("{FONT_SMALL}¥10,000{CLEAR_TO 0x40}500 COINS");
...
const u8 gText_Eevee_4500Coins[] = _("EEVEE{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_MrMime_8750Coins[] = _("MR. MIME{CLEAR_TO 0x48}{FONT_SMALL}8,750 COINS");
...
const u8 gText_Porygon_9000Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 9,000 COINS");
...
const u8 gText_PokeSum_PageName_PokemonIvs[] = _("POKéMON IVS");
const u8 gText_PokeSum_PageName_PokemonEvs[] = _("POKéMON EVS");
...
const u8 gText_PokeSum_Controls_Ivs[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}IVS");
const u8 gText_PokeSum_Controls_Evs[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}EVS");
const u8 gText_PokeSum_Controls_Stats[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}STATS");
...
const u8 gText_Flashback[] = _("FLASHBACKS");
const u8 gText_Version[] = _("VERSION 1.1.6");
...
const u8 gStartMenuDesc_PC[] = _("Check and organize POKéMON that are\nin the POKéMON Storage System (PC).");
